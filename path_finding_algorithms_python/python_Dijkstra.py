...
came_from, cost_so_far = dijkstra_search(GraphMap, (1, 2), (7, 8))
hf.draw_grid(GraphMap, width=3, point_to=came_from, start=(1, 4), goal=(7, 8))
print()
hf.draw_grid(GraphMap, width=3, number=cost_so_far, start=(1, 4), goal=(7, 8))
print()
